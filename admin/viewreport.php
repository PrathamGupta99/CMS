...
<table cellpadding="5" cellspacing="0" id="resultTable" border="1">
	...
	<?php
		...
		$result = mysqil_query(mysqli_connect($db_host,$db_user,$db_pass,$db_database), $qry2);
		while($row = mysqli_fetch_array($result))
			{
	...
	<?php
		...
		$result = mysqli_query(mysqli_connect($db_host,$db_user,$db_pass,$db_database), $qry1);
		while($row = mysqli_fetch_array($result))
			{
				echo '<tr class="record">';
